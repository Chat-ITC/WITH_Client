...
const Bottom = ({ logo }) => {
  ...
  const [imgMyPageClick, setImgMyPageClick] = useState(styles.nonClickImg1);
  const [strMyPageClick, setStrMyPageClick] = useState(styles.nonclickStr1);
  console.log(logo);
  ...
  useEffect(() => {
    switch (logo) {
      case "quiz":
        ...
        setImgMyPageClick(styles.nonClickImg1);
        setStrMyPageClick(styles.nonclickStr1);
        break;
      case "home":
      ...
      case "mypage":
        ...
        setImgHomeClick(styles.nonClickImg);
        setStrHomeClick(styles.nonclickStr);
        setImgMyPageClick(styles.clickImg1);
        setStrMyPageClick(styles.clickStr1);
        break;
      default:
        break;
    }
        ...
        <ul className={styles.BottomInfo}>
          <Link to="/Quiz">
            <li className={styles.bottomLink}>
              ...
              <div className={strQuizClick}>퀴즈</div>
            </li>
          </Link>
          <Link to="/HomePage">
            <li className={styles.bottomLink}>
              <img className={imgHomeClick} src={Logo} alt="홈" />
              <div className={strHomeClick}>홈</div>
            </li>
          </Link>
          <Link to="/MyPage">
            <li className={styles.bottomLink}>
              <img className={imgMyPageClick} src={MyPage} alt="내 정보" />
              <div className={strMyPageClick}>내 정보</div>
            </li>
          </Link>
        </ul>
      </nav>
